...
parser.add_argument('-o', '--output', help='Report file to output path')
...
if(validators.url(url)):
   ...
   if(config['password_inputs']):
     for passwordinput in password_inputs:
       if(passwordinput.get('type') != 'password'):
            report+='Password Issue: Plaintext password input found. Please change to password type input\n'
else:
	print("that wasn't a good url")
